...
var sw = self; // we still need to override the "self" variable
...
activateEvent();
var cacheClone = function (e) { return __awaiter(_this, void 0, void 0, function () {
    var res, resClone, cache;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch(e.request)];
            case 1:
                res = _a.sent();
                resClone = res.clone();
